...
import { KENNEY_FUTURE_NARROW_FONT_NAME } from '../assets/FontKeys.js';
import { animateText } from '../utils/text-utils.js';
import { AssetKeys } from '../assets/AssetKeys.js';
import { Colors } from '../assets/Colors.js';
import { FontSizes } from '../assets/FontSizes.js';
...
export class DialogUi {
    ...
    showDialogModal(messages : string[]) {
        ...
        const startY = this.#scene.cameras.main.height - this.#height - this.#padding / 4;
    ...
    #createPlayerInputCursor() {
        ...
        this.#userInputCursor = this.#scene.add.image(this.#width - 16, y, AssetKeys.UI_ASSET_KEYS.CURSOR);
