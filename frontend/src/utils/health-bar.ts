...
import { FontSize, PRIMARY_FONT_FAMILY, WIDTH, HEIGHT, POSITION_X, POSITION_Y, HEALTH_BAR_TEXT } from "common-ui/health-bar";
...
export class HealthBar {
  ...
  #updateBarGameObjects() {
    const constrainedWidth = Math.max(0, Math.min(this.#middle_green.displayWidth, this.#fullWidth));
