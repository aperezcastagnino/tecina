...
- [TypeScript 5.4.3](https://github.com/microsoft/TypeScript)
- [Vite 5.4.2](https://github.com/vitejs/vite)

## Requirements

[Node.js](https://nodejs.org) is required to install dependencies and run scripts via `npm`.
The Node version is: 20.8.1
...
The local development server runs on `http://localhost:5173` by default. Please see the Vite documentation if you wish to change this, or add SSL support.
